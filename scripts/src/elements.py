...
# ELEMENTS = {
#     'Ti': Element(atomic_nuber=22, lattice=6.290, bulk_modulus=110, debye_temperature=420, density=4510), # beta-ti
#     'Nb': Element(atomic_nuber=41, lattice=6.229, bulk_modulus=170, debye_temperature=275, density=8570), #
#     'Zr': Element(atomic_nuber=40, lattice=6.80, bulk_modulus=95, debye_temperature=270, density=6150), # beta-Zr
#     'Hf': Element(atomic_nuber=72, lattice=6.76, bulk_modulus=110, debye_temperature=250, density=13310), # 1.12*3.2A # hcp
#     'Ta': Element(atomic_nuber=73, lattice=6.240, bulk_modulus=200, debye_temperature=240, density=15578), # alpha-Ta
#     'Sc': Element(atomic_nuber=21, lattice=6.990, bulk_modulus=57, debye_temperature=355, density=2990), # 1.12*3.3A # hcp
#     'Y': Element(atomic_nuber=39, lattice=6.889, bulk_modulus=41, debye_temperature=210, density=6973), # ????
#     'La': Element(atomic_nuber=57, lattice=7.97, bulk_modulus=28, debye_temperature=135, density=6160), # 1.12*3.77A
#     'Mo': Element(atomic_nuber=42, lattice=5.947, bulk_modulus=250, debye_temperature=423, density=10250),
#     'W': Element(atomic_nuber=74, lattice=5.982, bulk_modulus=310, debye_temperature=400, density=19270),
