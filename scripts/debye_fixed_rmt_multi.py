...
def run_kkr_elastic_debye(**kwargs):
    ...
    try:
        ...
        Cp = tetra_fit["A2_Ry"] / (6.0 * vol)
        C44 = compute_c44_from_fit(c44_fit, vol=vol, c44_distortion=c44_distortion)

        # Also report the old/standard monoclinic-style normalization as a diagnostic.
        # This is useful when c44_mode=simple_shear.
        C44_A2_over_2V = c44_fit["A2_Ry"] / (2.0 * vol)
        C44_A2_over_4V = c44_fit["A2_Ry"] / (4.0 * vol)
        C44_2A2_over_V = 2.0 * c44_fit["A2_Ry"] / vol
        ...
        summary = {
            ...
            "C44_diagnostics_Ry_bohr3": {
                "A2_over_2V": float(C44_A2_over_2V),
                "A2_over_4V": float(C44_A2_over_4V),
                "2A2_over_V": float(C44_2A2_over_V),
            },
            ...
            "C44_diagnostics_GPa": {
                "A2_over_2V": float(C44_A2_over_2V * RY_BOHR3_TO_GPA),
                "A2_over_4V": float(C44_A2_over_4V * RY_BOHR3_TO_GPA),
                "2A2_over_V": float(C44_2A2_over_V * RY_BOHR3_TO_GPA),
            },
